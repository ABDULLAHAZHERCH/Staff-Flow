...
import { EmployeeNotificationsListConnected } from "@/components/dashboard/employee/notifications-list-connected"
import { Box, Typography, Card, CardHeader, CardContent, Tabs, Tab } from "@mui/material"
      ...
      <Box sx={{ width: "100%", display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Box sx={{ display: value === "all" ? "block" : "none" }}>
          <StyledCard>
            ...
            />
            <CardContent>
              <EmployeeNotificationsListConnected filter="all" />
            </CardContent>
          </StyledCard>
        </Box>
        ...
        <Box sx={{ display: value === "unread" ? "block" : "none" }}>
          <StyledCard>
            ...
            />
            <CardContent>
              <EmployeeNotificationsListConnected filter="unread" />
            </CardContent>
          </StyledCard>
        </Box>
      </Box>
