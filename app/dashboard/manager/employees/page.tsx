...
import { EmployeeListConnected } from "@/components/dashboard/manager/employee-list-connected";
      ...
      >
        ...
        <Box sx={{ display: activeTab === "active" ? "block" : "none" }}>
          <StyledCard data-tab="active">
            <CardHeader
              ...
              subheader={
                <Typography variant="body2" sx={{ color: "#64748b" }}>
                  Currently active employees in your organization
                </Typography>
              }
            />
            <CardContent>
              <EmployeeListConnected filterStatus="active" />
            </CardContent>
          </StyledCard>
        </Box>
        ...
        <Box sx={{ display: activeTab === "inactive" ? "block" : "none" }}>
          <StyledCard data-tab="inactive">
            ...
            />
            <CardContent>
              <EmployeeListConnected filterStatus="inactive" />
            </CardContent>
          </StyledCard>
        </Box>
