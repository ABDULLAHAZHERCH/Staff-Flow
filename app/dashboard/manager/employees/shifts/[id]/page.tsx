...
import { CalendarMonth, AccessTime, Edit, Add, Save, Delete } from "@mui/icons-material"
          ...
          <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, alignItems: "flex-start", gap: 3 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: 2, flex: 1 }}>
              ...
              <Box>
                ...
                <StyledBadge
                  badgeContent={employeeData.status === "active" ? "Active" : "Inactive"}
        ...
        <Box sx={{ display: "block" }}>
          <StyledCard>
            <CardHeader
              ...
              subheader={
                <Typography variant="body2" sx={{ color: "#64748b" }}>
                  Manage upcoming shifts for {employeeData.name}
                </Typography>
              }
            />
            <CardContent>
        ...
        <Box sx={{ display: "none" }}>
          <StyledCard>
            <CardHeader
              ...
              subheader={
                <Typography variant="body2" sx={{ color: "#64748b" }}>
                  Weekly availability for {employeeData.name}
                </Typography>
              }
            />
            <CardContent>
        ...
        <Box sx={{ display: "none" }}>
          <StyledCard>
            <CardHeader
              ...
              subheader={
                <Typography variant="body2" sx={{ color: "#64748b" }}>
                  Past shifts worked by {employeeData.name}
                </Typography>
              }
            />
