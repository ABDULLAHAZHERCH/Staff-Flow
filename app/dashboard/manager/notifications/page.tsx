...
import { ManagerNotificationsListConnected } from "@/components/dashboard/manager/notifications-list-connected"
      ...
      <Box sx={{ width: "100%", display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Box sx={{ display: value === "all" ? "block" : "none" }}>
          <StyledCard>
            ...
            />
            <CardContent>
              <ManagerNotificationsListConnected filter="all" />
            </CardContent>
          </StyledCard>
        </Box>
        ...
        <Box sx={{ display: value === "unread" ? "block" : "none" }}>
          <StyledCard>
            ...
            />
            <CardContent>
              <ManagerNotificationsListConnected filter="unread" />
            </CardContent>
          </StyledCard>
        </Box>
      </Box>
