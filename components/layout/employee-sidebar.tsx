...
import {
  Notifications, ArrowDropDown, Assignment, CreditCard, Home, Logout, Settings, Person
  ...
  return (
    <AppContainer>
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarSection>
            <SidebarLabel>EMPLOYEE DASHBOARD</SidebarLabel>
            <List>
              <Link href="/dashboard/employee" style={{ textDecoration: 'none' }}>
                <NavItem active={isActive('/dashboard/employee')}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Home sx={{ fontSize: 18, color: isActive('/dashboard/employee') ? '#03306b' : '#1a1a1a' }} />
                  </ListItemIcon>
                  <NavItemText primary="Dashboard" />
                </NavItem>
              </Link>
              <Link href="/dashboard/employee/reports" style={{ textDecoration: 'none' }}>
                <NavItem active={isActive('/dashboard/employee/reports')}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Assignment sx={{ fontSize: 18, color: isActive('/dashboard/employee/reports') ? '#03306b' : '#1a1a1a' }} />
                  </ListItemIcon>
                  <NavItemText primary="My Reports" />
                </NavItem>
              </Link>
              <Link href="/dashboard/employee/payroll" style={{ textDecoration: 'none' }}>
                <NavItem active={isActive('/dashboard/employee/payroll')}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <CreditCard sx={{ fontSize: 18, color: isActive('/dashboard/employee/payroll') ? '#03306b' : '#1a1a1a' }} />
                  </ListItemIcon>
                  <NavItemText primary="Payroll" />
                </NavItem>
              </Link>
              <Link href="/dashboard/employee/notifications" style={{ textDecoration: 'none' }}>
                <NavItem active={isActive('/dashboard/employee/notifications')}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1, position: 'relative' }}>
                    <NotificationBadge badgeContent={2}>
                      <Notifications sx={{ fontSize: 18, color: isActive('/dashboard/employee/notifications') ? '#03306b' : '#1a1a1a' }} />
                    </NotificationBadge>
                  </ListItemIcon>
        ...
        <SidebarFooter>
          <DropdownButton onClick={handleDropdownOpen}>
            <StyledAvatar>E</StyledAvatar>
            <UserInfo>
              <UserName>Jane Employee</UserName>
              <UserEmail>employee@staffflow.com</UserEmail>
            </UserInfo>
