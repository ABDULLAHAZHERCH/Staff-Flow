            ...
            <List>
                ...
                <NavItem active={isActive("/dashboard/employee")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Home
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/employee")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                ...
                <NavItem active={isActive("/dashboard/employee/reports")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Assignment
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/employee/reports")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                ...
                <NavItem active={isActive("/dashboard/employee/payroll")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <CreditCard
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/employee/payroll")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
              ...
              >
                <NavItem active={isActive("/dashboard/employee/notifications")}>
                  <ListItemIcon
                    sx={{ minWidth: 0, mr: 1, position: "relative" }}
                  >
                    <NotificationBadge badgeContent={0}>
                      <Notifications
                        sx={{
                          fontSize: 18,
                          color: isActive("/dashboard/employee/notifications")
                            ? "#03306b"
                            : "#1a1a1a",
                        }}
                      />
        ...
        <SidebarFooter>
          <DropdownButton onClick={handleDropdownOpen}>
            ...
            <UserInfo>
              ...
              <UserEmail>
                {userData ? userData.email : "employee@staffflow.com"}
              </UserEmail>
            </UserInfo>
