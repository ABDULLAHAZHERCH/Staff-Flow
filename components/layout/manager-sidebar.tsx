        ...
        <SidebarContent>
          <SidebarSection>
            ...
            <List>
                ...
                <NavItem active={isActive("/dashboard/manager")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Home
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/manager")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                ...
                <NavItem active={isActive("/dashboard/manager/employees")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <People
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/manager/employees")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                ...
                <NavItem active={isActive("/dashboard/manager/reports")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <Assignment
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/manager/reports")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                ...
                <NavItem active={isActive("/dashboard/manager/payroll")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <CreditCard
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/manager/payroll")
                          ? "#03306b"
                          : "#1a1a1a",
                      }}
                    />
                  ...
                  >
                    <NotificationBadge badgeContent={0}>
                      <Notifications
                        sx={{
                          fontSize: 18,
                          color: isActive("/dashboard/manager/notifications")
                            ? "#03306b"
                            : "#1a1a1a",
                        }}
                      />
              ...
              <Link
                href="/dashboard/manager/ai-scheduling"
                style={{ textDecoration: "none" }}
              >
                <NavItem active={isActive("/dashboard/manager/ai-scheduling")}>
                  <ListItemIcon sx={{ minWidth: 0, mr: 1 }}>
                    <AutoAwesome
                      sx={{
                        fontSize: 18,
                        color: isActive("/dashboard/manager/ai-scheduling")
                          ? "#03306b"
                          : "#c61111",
                      }}
                    />
